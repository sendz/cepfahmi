...
class Email_reader {
      ...
      private $user   = 'sendy@lendabook.co';
      private $pass   = 'karynkireina';
      ...
      function connect() {
          $this->conn = imap_open('{'.$this->server.':'.$this->port.'/imap/ssl}INBOX', $this->user, $this->pass);
      }
      ...
      function get($msg_index=NULL) {
          ...
          elseif ( ! is_null($msg_index) && isset($this->inbox[$msg_index])) {
              return imap_utf8($this->inbox[$msg_index]);
          }

          return imap_utf8($this->inbox[0]);
      }
